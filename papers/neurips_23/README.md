...
- [Train your own MARL agents with PyMarl as in the paper](papers/neurips_23/pymarl/README.md)
- [Reproduce the results of the paper](papers/neurips_23/pymarl/README.md)
