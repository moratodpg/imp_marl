...
def _get_config(params, arg_name, subfolder):
    ...
    if config_name is not None:
        with open(os.path.join(os.path.dirname(__file__), "pymarl/config", subfolder, "{}.yaml".format(config_name)), "r") as f:
            try:
...
if __name__ == '__main__':
    ...
    with open(os.path.join(os.path.dirname(__file__), "pymarl/config", "default.yaml"), "r") as f:
        try:
            config_dict = yaml.load(f)
        except yaml.YAMLError as exc:
